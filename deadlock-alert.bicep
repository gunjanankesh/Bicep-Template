param metricAlerts_ONEPDM_DEV_DB_DEADLOCK_ALERT_name string = 'ONEPDM-DEV-DB-IDENTITY-DEADLOCK-ALERT'
...
resource metricAlerts_ONEPDM_DEV_DB_DEADLOCK_ALERT_name_resource 'Microsoft.Insights/metricAlerts@2018-03-01' = {
  name: metricAlerts_ONEPDM_DEV_DB_DEADLOCK_ALERT_name
  location: 'global'
  tags: {
